...
namespace GPassword
{
    public partial class Form1 : Form
    {
        ...
        string alf0 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefjhigklmnopqrstuvwxyz{}}();:./|<>!@#$%^&*1234567890№`~?-=+¶Θ۞‡ↀ∑∭⏎☺☻✸♋♕➲♫♡©®●►▲◄▼☮☂☎☠☽☾✉✈♣♤♥♦♧☄☊☭☁ϟ┿❀✾✿✄✪♞☯абвгдеёжзийклмнопрстуфхцчшщъыьэюяАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ";
        string alf1 = "";
        ...
        Font drawFont = new Font("Times New Roman", 26);
        Font BigFont = new Font("Times New Roman", 50);
        SolidBrush GreenBrush = new SolidBrush(Color.GreenYellow);
        SolidBrush GainBrush = new SolidBrush(Color.Gainsboro);
        ...
        {
            Mx = Ex; My = Ey;
            if (Mx > 400 - a_k) Mx = (400 - a_k); if (My > 400 - a_k) My = (400 - a_k);
